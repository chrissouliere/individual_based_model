...
to setup-agents
  ...
  [
    ...
    [
      ...
      file-print csv:to-row (list "run number" "ticks" "location-who" "location-xcor" "location-ycor" "location-spring-body-mass" "location-body-mass")
      file-close
    ]
    [print error-message]
  ]
...
to record-location
  ...
  file-open (word "../output/location_results_" behaviorspace-run-number ".csv")
  file-print csv:to-row (list behaviorspace-run-number ticks location-who location-xcor location-ycor location-spring-body-mass location-body-mass)
  file-close
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="Resultsv17" repetitions="100" runMetricsEveryStep="false">
