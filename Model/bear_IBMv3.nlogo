...
ask turtles [
    ...
    set hourly-energy 0
    set max-energy-hourly (222 * body-mass) / 14 ; Average maximum daily intake in kcal DE of bears on mixed diet * BM (kg) divided by the average maximum hours spent foraging per day
...
to-report mean-radius-energy
  let b [patches in-radius 2] of patch-here
  let c sum [available-patch-energy] of b / count b ; average available-patch-energy over 13 patches
  report c
end
