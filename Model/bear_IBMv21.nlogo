...
to determine-dist-timestep ; mean movement rate per hour / ; 60 m
  ifelse (sex = "male")
  [
    if (age >= 5) [set mean-dist-timestep 4000 set sd-dist-timestep 100] ;34
    if (age >= 2 and age < 5) [set mean-dist-timestep 3353 set sd-dist-timestep 100] ;27
  ]
  [
    ...
    if (age >= 5 and attendant-cub? = FALSE and attendant-yearling? = FALSE) [set mean-dist-timestep 2862 set sd-dist-timestep 100] ;24
    if (age >= 2 and age < 5 and attendant-cub? = FALSE and attendant-yearling? = FALSE) [set mean-dist-timestep 3588 set sd-dist-timestep 100] ;27
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="Resultsv20" repetitions="20" runMetricsEveryStep="false">
