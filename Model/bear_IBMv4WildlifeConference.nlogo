...
to setup-landscape
  ...
  set landscape-energy gis:load-dataset ("../../IBMData/NLogo/OldLayers/corsec_ro_60.asc")
  ...
  set core-secondary gis:load-dataset ("../../IBMData/NLogo/OldLayers/gb_bma3_dissolve.shp")
  ...
  ;set dig-energy-patches patches with [pcolor != blue and pcolor != yellow and pcolor != black]
   ...
   if(file-exists? "../output/BankBalanceStatsOutput.csv")
  [
    carefully
    [file-delete "../output/BankBalanceStatsOutput.csv"]
    [print error-message]
  ]

  file-open "../output/BankBalanceStatsOutput.csv"
  file-type "tick," ; file-type vs file-print?
  file-type "month,"
  file-print "day" ; Chap 11.4
  file-close
...
to update-tick-output
  file-open "../output/BankBalanceStatsOutput.csv"
  file-type (word ticks ",")
  file-type (word month ",")
  file-print day-of-year
  file-close
end
...
to update-plot
  ...
  plot mean [body-mass] of turtles with [sex = "female" and age < 5]
  export-plot "Mean Body Mass of Bears" "../output/MeanBodyMass5.csv" ; need to make sure this files opens and closes once, rather than opening on every tick.
end
