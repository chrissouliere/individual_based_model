...
;   if (month = 5 and day-of-month >= 15) [
;    set weights-applied?  FALSE
;    if (weights-applied? = FALSE) [
;      set fruit-energy fruit-energy * item 0 weights energy-weights
;      set forb-energy forb-energy * item 1 weights energy-weights
...
;    ]
;  ]
;   if (month = 6 and day-of-month >= 1 and day-of-month < 15) [
;    set weights-applied?  FALSE
;    if (weights-applied? = FALSE) [
;      set fruit-energy fruit-energy * item 0 weights energy-weights
;      set forb-energy forb-energy * item 1 weights energy-weights
...
;    ]
;  ]
;   if (month = 6 and day-of-month >=  15) [
;    set weights-applied?  FALSE
;    if (weights-applied? = FALSE) [
;      set fruit-energy fruit-energy * item 0 weights energy-weights
;      set forb-energy forb-energy * item 1 weights energy-weights
...
;    ]
;  ]
;  if (month = 5 and day-of-month = 1 and hour-of-day = 0) [set fruit-energy fruit-energy * item 0 weights energy-weights]
;  if (month = 5 and day-of-month = 15 and hour-of-day = 0) [set fruit-energy fruit-energy * item 0 weights energy-weights]
;  if (month = 6 and day-of-month = 1 and hour-of-day = 0) [set fruit-energy fruit-energy * item 0 weights energy-weights]
...
;  if (month = 4 and day-of-month >= 15) [report map [i -> item 0 i] a]
;  if (month = 5 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 1 i] a]
;  if (month = 5 and day-of-month >= 15) [report map [i -> item 2 i] a]
;  if (month = 6 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 3 i] a]
;  if (month = 6 and day-of-month >= 15) [report map [i -> item 4 i] a]
;  if (month = 7 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 5 i] a]
;  if (month = 7 and day-of-month >= 15) [report map [i -> item 6 i] a]
;  if (month = 8 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 7 i] a]
;  if (month = 8 and day-of-month >= 15) [report map [i -> item 8 i] a]
;  if (month = 9 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 9 i] a]
;  if (month = 9 and day-of-month >= 15) [report map [i -> item 10 i] a]
;  if (month = 10 and day-of-month >= 1 and day-of-month < 15) [report map [i -> item 11 i] a]
end
