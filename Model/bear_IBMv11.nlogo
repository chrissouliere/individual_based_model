...
to record-results
  if(results-on? = TRUE)
  [
    set bear-age [age] of turtles
    set bear-sex [sex] of turtles
    set bear-age-class [age-class] of turtles
    set bear-spring-body-mass [spring-body-mass] of turtles
    set bear-body-mass [body-mass] of turtles
    set bear-survival-rates [bear-survival-rate] of turtles
    set bear-survive [bear-survive?] of turtles
    set bear-road-freq [road-freq] of turtles
    set bear-road-dens [0.04268 + 0.005212 * road-freq] of turtles
    set bear-total-dist [total-dist] of turtles
    set bear-current-bci [current-bci] of turtles
  ;bear-dig-energy
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="Resultsv1" repetitions="1" runMetricsEveryStep="false">
