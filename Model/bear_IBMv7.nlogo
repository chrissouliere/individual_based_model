...
to random-walk
  ca ; clear-all
  set watershed-area gis:load-dataset ("../../IBMData/NLogo/wts_corsec4MP.shp")
  ...
  ask patches [
    ...
    if (road-value = 1 or road-value = 2) [set pcolor 7]
...
to setup-random-walk
  ...
  ;ask patches one-of patches with [watershed-id = 0.666282702] [sprout-turtle 1]]
  ;set xy
