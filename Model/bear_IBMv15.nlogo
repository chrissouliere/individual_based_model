...
to record-location
  ...
  set location-xcor map[x -> [xcor] of x] sort turtles
  set location-ycor map[x -> [ycor] of x] sort turtles
...
@#$#@#$#@
<experiments>
  <experiment name="Resultsv15" repetitions="10" runMetricsEveryStep="false">
