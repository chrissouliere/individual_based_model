...
[
  ...
  aalk-dataset ; Amelanchier alnifolia
  ant-dataset  ; Ants
  auv-dataset  ; Arctostaphylos uva-ursi
  equ-dataset  ; Equisetum spp.
  fvi-dataset  ; Fragaria virginiana
  hed-dataset  ; Hedysarum spp.
  hla-dataset  ; Heracleum lanatum
  lin-dataset  ; Lonicera involucrata
  rib-dataset  ; Ribes spp.
  rid-dataset  ; Rubus idaeus
  rpa-dataset  ; Rubus parviflorus
  sca-dataset  ; Shepherdia canadensis
  tof-dataset  ; Taraxacum officinale
  tri-dataset  ; Trifolium spp.
  ved-dataset  ; Viburnum edule
  vme-dataset  ; Vaccinium membranaceum
  vmy-dataset  ; Vaccinium myrtilloides
  vsc-dataset  ; Vaccinium scoparium
  vvi-dataset  ; Vaccinium vitis-idaea
  ung-dataset  ; Ungulates
  hour-of-day
  day-of-year
  month
  year
...
[
  ...
  updated-patch-energy ; available energy updated when bear occupies patch
...
to setup-landscape
  ...
  ;set landscape-energy gis:load-dataset ("../../IBMData/NLogo/corsec_ro_60.asc")
  set core-secondary gis:load-dataset ("../../IBMData/NLogo/gb_uf_veg_Dissolve_core_sec.shp")
  set aalk-dataset gis:load-dataset ("../../IBMData/NLogo/aalk_int_60b.asc")
  set ant-dataset gis:load-dataset  ("../../IBMData/NLogo/ant_int_60b.asc")
  set auv-dataset gis:load-dataset  ("../../IBMData/NLogo/auv_int_60b.asc")
  set equ-dataset gis:load-dataset  ("../../IBMData/NLogo/equ_int_60b.asc")
  set fvi-dataset gis:load-dataset  ("../../IBMData/NLogo/fvi_int_60b.asc")
  set hed-dataset gis:load-dataset  ("../../IBMData/NLogo/hed_int_60b.asc")
  set hla-dataset gis:load-dataset  ("../../IBMData/NLogo/hla_int_60b.asc")
  set lin-dataset gis:load-dataset  ("../../IBMData/NLogo/lin_int_60b.asc")
  set rib-dataset gis:load-dataset  ("../../IBMData/NLogo/rib_int_60b.asc")
  set rid-dataset gis:load-dataset  ("../../IBMData/NLogo/rid_int_60b.asc")
  set rpa-dataset gis:load-dataset  ("../../IBMData/NLogo/rpa_int_60b.asc")
  set sca-dataset gis:load-dataset  ("../../IBMData/NLogo/sca_int_60b.asc")
  set tof-dataset gis:load-dataset  ("../../IBMData/NLogo/tof_int_60b.asc")
  set tri-dataset gis:load-dataset  ("../../IBMData/NLogo/tri_int_60b.asc")
  set ved-dataset gis:load-dataset  ("../../IBMData/NLogo/ved_int_60ab.asc")
  set vme-dataset gis:load-dataset  ("../../IBMData/NLogo/vme_int_60b.asc")
  set vmy-dataset gis:load-dataset  ("../../IBMData/NLogo/vmy_int_60b.asc")
  set vsc-dataset gis:load-dataset  ("../../IBMData/NLogo/vsc_int_60b.asc")
  set vvi-dataset gis:load-dataset  ("../../IBMData/NLogo/vvi_int_60b.asc")
  set ung-dataset gis:load-dataset  ("../../IBMData/NLogo/ung_int_60b.asc")



  gis:set-world-envelope (gis:envelope-union-of (gis:envelope-of aalk-dataset)
                                                (gis:envelope-of ant-dataset)
                                                (gis:envelope-of auv-dataset)
                                                (gis:envelope-of equ-dataset)
                                                (gis:envelope-of fvi-dataset)
                                                (gis:envelope-of hed-dataset)
                                                (gis:envelope-of hla-dataset)
                                                (gis:envelope-of lin-dataset)
                                                (gis:envelope-of rib-dataset)
                                                (gis:envelope-of rid-dataset)
                                                (gis:envelope-of rpa-dataset)
                                                (gis:envelope-of sca-dataset)
                                                (gis:envelope-of tof-dataset)
                                                (gis:envelope-of tri-dataset)
                                                (gis:envelope-of ved-dataset)
                                                (gis:envelope-of vme-dataset)
                                                (gis:envelope-of vmy-dataset)
                                                (gis:envelope-of vsc-dataset)
                                                (gis:envelope-of vvi-dataset)
                                                (gis:envelope-of ung-dataset))
  gis:apply-raster aalk-dataset aalk-energy
  gis:apply-raster ant-dataset ant-energy
  gis:apply-raster auv-dataset auv-energy
  gis:apply-raster equ-dataset equ-energy
  gis:apply-raster fvi-dataset fvi-energy
  gis:apply-raster hed-dataset hed-energy
  gis:apply-raster hla-dataset hla-energy
  gis:apply-raster lin-dataset lin-energy
  gis:apply-raster rib-dataset rib-energy
  gis:apply-raster rid-dataset rid-energy
  gis:apply-raster rpa-dataset rpa-energy
  gis:apply-raster sca-dataset sca-energy
  gis:apply-raster tof-dataset tof-energy
  gis:apply-raster tri-dataset tri-energy
  gis:apply-raster ved-dataset ved-energy
  gis:apply-raster vme-dataset vme-energy
  gis:apply-raster vmy-dataset vmy-energy
  gis:apply-raster vsc-dataset vsc-energy
  gis:apply-raster vvi-dataset vvi-energy
  gis:apply-raster ung-dataset ung-energy
  ;set landscape-energy gis:load-dataset ("../../IBMData/NLogo/aalk_60.asc")
  ;set ant-energy gis:load-dataset ("../../IBMData/NLogo/ant_60.asc")
  ;gis:set-world-envelope gis:envelope-of landscape-energy ; need this if bringing in multiple layers
;  gis:apply-raster ant-energy dig-energy
;  gis:apply-raster landscape-energy ant-energy2


;  ask patches [set dig-energy
;    patches with [aalk-energy <= 0 or aalk-energy >= 0]
;    ;patches with [ant-energy <= 0 or ant-energy >= 0]
;  ]



  ask patches [
    ifelse (isNAN(aalk-energy) = TRUE)
    [
      set pcolor black
    ...
    [
      set dig-energy (aalk-energy + ant-energy + auv-energy + equ-energy + fvi-energy + hed-energy + hla-energy + lin-energy + rib-energy + rid-energy + rpa-energy + sca-energy + tof-energy + tri-energy + ved-energy + vme-energy +
          vmy-energy + vsc-energy + vvi-energy + ung-energy)
      set pcolor green
  ...
  let max-dig-energy max [dig-energy] of patches with [pcolor = green]
      ;set pcolor scale-color green dig-energy (0 - 10000) (1000 + 10000)

  ask patches [
    if (pcolor = green) [set pcolor scale-color green dig-energy (min-dig-energy - 10000) (max-dig-energy + 10000)]
    if (I-am-out-of-bounds? = TRUE) [set pcolor black] ; to deal with last column
    ]

  ;resize-world 0 gis:width-of ung-dataset - 1 0 gis:height-of ung-dataset - 1; [gis:width-of landscape-energy - 1] removes the last column because the first column in NetLogo starts at 0 and not 1, which ArcMap does
...
;
;    ifelse (pcolor = black) [set dig-energy 0 set I-am-out-of-bounds? TRUE][set I-am-out-of-bounds? FALSE] ;after adjusting patch color and area-id, set non-green patches (roads and black area [formely dig-energy NaN]) dig-energy to 0
;    ifelse (pcolor = 4 or pcolor = 7) [set dig-energy 0 set I-am-road? TRUE][set I-am-road? FALSE]
;
;   ;set dig-energy (dig-energy * 10)
;
;   ;set patch-with-energy patches with [dig-energy > 0]
;   set hourly-patch-energy (dig-energy / ((319 + 1) - 97) / 24) ; hourly patch energy
;   set updated-patch-energy hourly-patch-energy
...
to determine-dist-timestep ; mean movement rate per hour / ; 50 m
  if (sex = "male" and age >= 5) [set mean-dist-timestep 408 set sd-dist-timestep 649.7] ;34
  if (sex = "male" and age >= 2 and age < 5) [set mean-dist-timestep 342 set sd-dist-timestep 522.3] ;27
  if (sex = "female" and age >= 5) [set mean-dist-timestep 292 set sd-dist-timestep 459.6] ;24
  if (sex = "female" and age >= 2 and age < 5) [set mean-dist-timestep 366 set sd-dist-timestep 506.4] ;27
  if (sex = "female" and age >= 1 and age < 2) [set mean-dist-timestep 297 set sd-dist-timestep 449.6] ; will need to adjust the if condition for attending-yearling ;24
  if (sex = "female" and age < 1) [set mean-dist-timestep 191 set sd-dist-timestep 317.8] ; will need to adjust the if condition for attending-cub ;16
end
...
to update-patch-energy
  ...
  let ideal-patch max-one-of potential-patches [updated-patch-energy] ; of potential-patches, patch with maximum updated-patch-energy value

  ask potential-patches
  [
    set current-tick (ticks + 1)
    set updated-patch-energy (current-tick * hourly-patch-energy)
    set available-patch-energy updated-patch-energy
    if (patch-consumed? = TRUE) [set available-patch-energy (available-patch-energy - energy-consumed)] ; substract energy that has already been consumed by previous bear
  ]
...
to-report mean-radius-energy
  ...
  let c sum [available-patch-energy] of b / count b ; average updated-patch-energy over 13 patches
  report c
end
...
"sub-adult male" 1.0 0 -5325092 true "" ""
"adult female" 1.0 0 -11221820 true "" ""
"sub-adult female" 1.0 0 -4528153 true "" ""
