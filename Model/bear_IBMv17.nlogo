...
[
  ...
  ;min-energy-hourly; global switch
...
@#$#@#$#@
<experiments>
  <experiment name="Resultsv15" repetitions="5" runMetricsEveryStep="false">
...
initialize-bear-param</setup>
    ...
    <steppedValueSet variable="active-coeff" first="0.6" step="0.2" last="1.6"/>
    <steppedValueSet variable="min-energy-hourly" first="2000" step="100" last="3000"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
