...
to setup-landscape
  ca ; clear-all
  gis:load-coordinate-system ("data/BMA3.prj")
  set mod-mask gis:load-dataset ("data/BMA3.shp")
  set roads gis:load-dataset ("data/road_raster.asc")
  gis:set-world-envelope gis:envelope-of mod-mask
  gis:apply-raster roads habitat-type
